...
function Sidebar({ component, setComponent }){
 ...
 const menuItems = [
  ...
  return (
    <div className='h-screen w-64 bg-gradient-to-b from-gray-900 via-slate-900 to-gray-900 border-r border-gray-800 flex flex-col shadow-2xl relative overflow-hidden'>
        ...
        <div className='relative p-6 border-b border-gray-800/50'>
            <div className='flex flex-col items-center space-y-3'>
                ...
                <div className='px-4 py-1.5 bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-full hover:from-blue-600/30 hover:to-purple-600/30 hover:border-blue-500/50 transition-all duration-300 cursor-pointer backdrop-blur-sm'>
                    <span className='text-xs text-blue-400 font-semibold'>{blogs?.blogs?.length || 0} Posts Published</span>
                </div>
            </div>
        </div>
        ...
        <nav className='relative flex-1 px-4 py-6 space-y-2 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent'>
            <div className='mb-4'>
                ...
                <div className='h-px bg-gradient-to-r from-transparent via-gray-700 to-transparent mt-2'></div>
            </div>
            ...
            {menuItems.map((item, index) => {
                ...
                return (
                    ...
                    >
                        {!isActive && (
                            <>
                                <div className='absolute inset-0 bg-gradient-to-r from-blue-600/0 via-purple-600/0 to-blue-600/0 group-hover:from-blue-600/10 group-hover:via-purple-600/10 group-hover:to-blue-600/10 transition-all duration-500'></div>
        ...
        <div className='relative p-4 border-t border-gray-800/50 backdrop-blur-sm'>
            ...
            >
                <div className='absolute inset-0 bg-gradient-to-t from-white/0 to-white/0 group-hover:from-white/0 group-hover:to-white/10 transition-all duration-300'></div>
